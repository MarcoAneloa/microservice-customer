package com.microservice.customer.infrastructure.controller;

import com.microservice.customer.domain.model.Customer;
import com.microservice.customer.domain.usecase.command.CreateCustomerUseCase;
import com.microservice.customer.domain.usecase.command.DeleteCustomerUseCase;
import com.microservice.customer.domain.usecase.command.UpdateCustomerUseCase;
import com.microservice.customer.domain.usecase.query.GetCustomersUseCase;
